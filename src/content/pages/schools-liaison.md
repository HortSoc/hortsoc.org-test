...
notes: Converted conservatively from the published WordPress page body. The legacy WordPress slideshow has been replaced with a structured static gallery using the original attachment images.
---
...
A selection of photographs from the schools liaison projects and displays appears below.
